...
<script>
    ...
    function display()
    {
        ...
        if (seconds == 0)
        {
            $('.download-timer').html("<a class='btn btn-free' href='<?php echo validation::safeOutputToScreen($file->getNextDownloadPageLink()); ?>'><?php echo pluginHelper::pluginEnabled('mediaplayer') ? t("download_or_view_now", "download / view now") : t("download_now", "download now"); ?></a>");
        }
        else
        {
                ...
                <tr>
                    ...
                    <th class="col-md-3">
                        <a href="#" onClick="display();
                                return false;" class="btn btn-free-element">
